...
//    }
    ...
    public ResponseEntity<ResponseClub> addClub(ResponseClubCreate request)  throws IOException {
    ...
    @PutMapping("/update")
    public ResponseEntity<ClubUpdateRequest> changeClub(ResponseClubUpdate request) throws IOException {
