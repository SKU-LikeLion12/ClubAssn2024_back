...
public class JoinClubController {
    ...
    @Operation(summary = "동아리원 추가", description = "", tags = {"manage"},
...
//        }
    ...
    @Operation(summary = "동아리원 삭제", description = "학번과 동아리 이름을 받아 동아리원 삭제", tags = {"manage"},
    ...
    @Operation(summary = "동아리원 검색", description = "학번, 이름, 동아리로 검색하면 알맞은 동아리원 정보가 나옴", tags = {"manage"},
